...
output = open("C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\Level1JobScrollParis.htm", 'w')
# HTML Header Start
...
# HTML Header End
output.write('\n')
with open('C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\DailyPostingParis.csv', "r") as f:
