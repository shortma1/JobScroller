...
output = open("C:\\Users\\short\\PycharmProjects\\ScrollerParser\\Level1JobScrollSS.htm", 'w')
# HTML Header Start
...
with open('C:\\Users\\short\\PycharmProjects\\ScrollerParser\\DailyPostingSS.csv', "r") as f:
