...
output = open("C:\\Users\\short\\PycharmProjects\\ScrollerParser\\Level1JobScrollMTP.htm", 'w')
# HTML Header Start
...
with open('C:\\Users\\short\\PycharmProjects\\ScrollerParser\\DailyPostingMTP.csv', "r") as f:
