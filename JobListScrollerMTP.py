...
output = open("C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\Level1JobScrollMTP.htm", 'w')
# HTML Header Start
...
output.write('<center>')
output.write('\n')
output.write('<i>Daily Mt Pleasant Job Postings for ')
...
# HTML Header End
output.write('\n')
with open('C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\DailyPostingMTP.csv', "r") as f:
