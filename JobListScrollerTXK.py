...
output = open("C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\Level1JobScrollTXK.htm", 'w')
# HTML Header Start
...
# HTML Header End
output.write('\n')
with open('C:\\Users\\shortma1\\PycharmProjects\\ScrollerParser\\DailyPostingTXK.csv', "r") as f:
