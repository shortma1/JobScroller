...
output = open("C:\\Users\\short\\PycharmProjects\\ScrollerParser\\Level1JobScrollTXK.htm", 'w')
# HTML Header Start
...
output.write('<head>\n')
output.write('<meta http-equiv="refresh" content="2700" />\n')
...
output.write('<center>\n')
output.write('<i>Daily Texarkana Job Postings for ')
...
with open('C:\\Users\\short\\PycharmProjects\\ScrollerParser\\DailyPostingTXK.csv', "r") as f:
